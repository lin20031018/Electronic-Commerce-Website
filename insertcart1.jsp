...
<%
    ...
    try {
        ...
        String sql = "INSERT INTO cart (username, productCategory, productID, quantity, productPrice, productStock, cartdate) VALUES (?, 'allplantpots', ?, ?, ?, ?, ?)";
    ...
    response.sendRedirect("product1.jsp?productID=" + productID);
%>
<html>
<body>
</body>
