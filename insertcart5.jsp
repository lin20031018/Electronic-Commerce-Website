...
<%
    ...
    try {
        ...
        String sql = "INSERT INTO cart (username, productCategory, productID, quantity, productPrice, productStock, cartdate) VALUES (?, 'kilnplantpot', ?, ?, ?, ?, ?)";
    ...
    response.sendRedirect("product5.jsp?productID=" + productID);
%>
<html>
<body>
</body>
