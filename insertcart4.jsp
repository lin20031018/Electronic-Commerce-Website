...
<%
    ...
    try {
        ...
        String sql = "INSERT INTO cart (username, productCategory, productID, quantity, productPrice, productStock, cartdate) VALUES (?, 'glassplantpot', ?, ?, ?, ?, ?)";
    ...
    response.sendRedirect("product4.jsp?productID=" + productID);
%>
<html>
<body>
</body>
