...
<body>
    ...
    try {
        ...
        String sql = "SELECT * FROM cementplantpot WHERE `productID`=?";
        ...
        cementplantpotContent = rs.getString("cementplantpotContent");
	%>
    ...
    <div class="all">
		...
		<form action="insertcart6.jsp" method="post" class="whole">
        ...
        <section class="below">
            ...
            <div class="CommentSection">
				...
				try {
					...
					String query = "SELECT username, content, rating, commentdate FROM comment WHERE productID = ? AND productCategory = 'cementplantpot' ORDER BY commentdate DESC";
       ...
       <div class="press">
            ...
            <form action="insertcomment6.jsp" method="post" class="commentForm">
                <div class="MyCm">
