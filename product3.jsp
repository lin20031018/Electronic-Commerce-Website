...
<body>
    ...
    try {
        ...
        String sql = "SELECT * FROM rhinoplantpot WHERE `productID`=?";
        ...
        rhinoplantpotContent = rs.getString("rhinoplantpotContent");
	%>
    ...
    <div class="all">
		...
		<form action="insertcart3.jsp" method="post" class="whole">
        ...
        <section class="below">
            ...
            <div class="CommentSection">
				...
				try {
					...
					String query = "SELECT username, content, rating, commentdate FROM comment WHERE productID = ? AND productCategory = 'rhinoplantpot' ORDER BY commentdate DESC";
       ...
       <div class="press">
            ...
            <form action="insertcomment3.jsp" method="post" class="commentForm">
                <div class="MyCm">
