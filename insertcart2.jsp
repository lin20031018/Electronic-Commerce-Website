...
<%
    ...
    try {
        ...
        String sql = "INSERT INTO cart (username, productCategory, productID, quantity, productPrice, productStock ,cartdate) VALUES (?, 'squareplantpot', ?, ?, ?, ?, ?)";
    ...
    response.sendRedirect("product2.jsp?productID=" + productID);
%>
<html>
<body>
</body>
