...
<%
   ...
   try {
        ...
        String sql = "INSERT INTO cart (username, productCategory, productID, quantity, productPrice, productStock, cartdate) VALUES (?, 'rhinoplantpot', ?, ?, ?, ?, ?)";
    ...
    response.sendRedirect("product3.jsp?productID=" + productID);
%>
<html>
<body>
</body>
