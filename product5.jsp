...
<body>
    ...
    try {
        ...
        String sql = "SELECT * FROM kilnplantpot WHERE `productID`=?";
        ...
        kilnplantpotContent = rs.getString("kilnplantpotContent");
	%>
    ...
    <div class="all">
		...
		<form action="insertcart5.jsp" method="post" class="whole">
        ...
        <section class="below">
            ...
            <div class="CommentSection">
				...
				try {
					...
					String query = "SELECT username, content, rating, commentdate FROM comment WHERE productID = ? AND productCategory = 'kilnplantpot' ORDER BY commentdate DESC";
        ...
        <div class="press">
            ...
            <form action="insertcomment5.jsp" method="post" class="commentForm">
                <div class="MyCm">
