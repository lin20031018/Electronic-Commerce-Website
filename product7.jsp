...
<body>
    ...
    try {
        ...
        String sql = "SELECT * FROM homegoods WHERE `productID`=?";
        ...
        homegoodsContent = rs.getString("homegoodsContent");
	%>
    ...
    <div class="all">
       ...
       <section class="BuySection">
            <form action="insertcart7.jsp" method="post" class="whole">
        ...
        <section class="below">
            ...
            <div class="CommentSection">
				...
				try {
					...
					String query = "SELECT username, content, rating, commentdate FROM comment WHERE productID = ? AND productCategory = 'homegoods' ORDER BY commentdate DESC";
        ...
        <div class="press">
            ...
            <form action="insertcomment7.jsp" method="post" class="commentForm">
                <div class="MyCm">
