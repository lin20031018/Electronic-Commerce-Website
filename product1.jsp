...
<body>
    ...
    try {
        ...
        String sql = "SELECT * FROM allplantpots WHERE `productID`=?";
        ...
        allplantpotsContent = rs.getString("allplantpotsContent");
	%>
    ...
    <div class="all">
        ...
        <section class="BuySection">
            <form action="insertcart1.jsp" method="post" class="whole">
            ...
            <div class="CommentSection">
                ...
                <div class="cm">
                    ...
                    try {
                        ...
                        String query = "SELECT username, content, rating, commentdate FROM comment WHERE productID = ? AND productCategory = 'allplantpots' ORDER BY commentdate DESC";
        ...
        <div class="press">
            ...
            <form action="insertcomment1.jsp" method="post" class="commentForm">
                <div class="MyCm">
