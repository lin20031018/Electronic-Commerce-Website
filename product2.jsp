...
<body>
    ...
    try {
        ...
        String sql = "SELECT * FROM squareplantpot WHERE `productID`=?";
        ...
        squareplantpotContent = rs.getString("squareplantpotContent");
	%>
  ...
  <div class="all">
		...
		<form action="insertcart2.jsp" method="post" class="whole">
        ...
        <section class="below">
            ...
            <div class="CommentSection">
				...
				try {
					...
					String query = "SELECT username, content, rating, commentdate FROM comment WHERE productID = ? AND productCategory = 'squareplantpot' ORDER BY commentdate DESC";
        ...
        <div class="press">
            ...
            <form action="insertcomment2.jsp" method="post" class="commentForm">
                <div class="MyCm">
